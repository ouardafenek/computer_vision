...
def get_dataset(batch_size, path,mean,std):
    """
...
def main(params,mean,std):
    ...
    train, test = get_dataset(params.batch_size, params.path,mean,std)
...
if __name__ == '__main__':
    ...
    print('parser',parser)
    parser.add_argument('--path', default='/tmp/datasets/cifar-10', type=str, metavar='DIR', help='path to dataset')
    ...
    main(args,mean,std)
    #a,b=get_dataset(2, '/tmp/datasets/cifar-10',mean,std)
    #for i, (input, target) in enumerate(a):
